...
import { orderConfirmation } from '../src/email-templates/index.js';
...
export async function POST(request) {
  ...
  try {
    ...
    try {
      ...
      const confirmationHtml = orderConfirmation({
        name: firstName,
        orderId,
        ...
        total,
        address: `${orderRow.address}, ${orderRow.city}, ${orderRow.state} ${orderRow.zip}`,
      });
